...
class CLIEngine {
    ...
    constructor(providedOptions) {
        ...
        console.dir(require("./simpleconfig/eslintconfig").importESLintRC(config));
        // Simple Config: Find the config file
        // const configFilePath = findup("eslint.config.js", { cwd: this.options.cwd });
        // console.log("Config file path is", configFilePath);

        // this.config = new ConfigArray(require(configFilePath), {
        //     basePath: path.dirname(configFilePath)
        // });

        // console.log("Config base path is", this.config.basePath);
